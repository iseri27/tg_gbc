...
from projects.mmdet3d_plugin.models.utils.misc import inverse_sigmoid
    ...
    def forward(
        ...
        **kwargs,
        ...
        for lvl, layer in enumerate(self.layers):
            ...
            if self._tgtg_info["enable"] and self._tgtg_info["r"][lvl] > 0:
                # [Nk, bs, E] -> [bs, Nk, E]
                ...
                key_pos = (
                    _trim(key_pos.contiguous().transpose(0, 1))
                    .contiguous()
                    .transpose(0, 1)
                )
        ...
        if not self.return_intermediate:
            ...
            cls_scores = cls_branches[lvl](query)
            bbox_preds = reg_branches[lvl](query)
            bbox_preds[..., 0:3] += reference[..., 0:3]
            bbox_preds[..., 0:3] = bbox_preds[..., 0:3].sigmoid()
